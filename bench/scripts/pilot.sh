...
#
# Usage: bash bench/scripts/pilot.sh <suite-id>
...
SUITE_ID=${1:?usage: pilot.sh <suite-id>}
...
record generate bash "$ROOT/bench/scripts/generate.sh" "$SUITE_ID"
record judge bash "$ROOT/bench/scripts/judge.sh" "$SUITE_ID"
record report python3 "$ROOT/bench/scripts/report.py" "$SUITE_ID"
